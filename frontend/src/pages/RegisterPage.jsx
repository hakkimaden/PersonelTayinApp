...
function RegisterPage({ setIsLoggedIn, setIsAdmin }) {
  ...
  const [currentAdliyeName, setCurrentAdliyeName] = useState(''); // Seçilen adliyenin adını tutmak için
  const [adliyeSearchTerm, setAdliyeSearchTerm] = useState('');
  const [showAdliyeDropdown, setShowAdliyeDropdown] = useState(false); // Dropdown'ı kontrol etmek için
         ...
         <div className="mb-4">
            ...
            <div className="relative" ref={adliyeDropdownRef}>
              <input
                ...
                value={currentAdliyeName || adliyeSearchTerm} // Seçili varsa seçilenin adını göster, aksi takdirde arama terimini göster
                onChange={(e) => {
