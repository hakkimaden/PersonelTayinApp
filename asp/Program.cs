...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var adliyeler = new List<Adliye>
        {
            ...
            new Adliye { Adi = "Burdur Adliyesi", Adres = "", ResimUrl = "https://rayp.adalet.gov.tr/Resimler/88/img-7871jpg08-07-202015-57.jpg", YapimYili = random.Next(1985, 2024), PersonelSayisi = random.Next(500, 7501), LojmanVarMi = (int)Math.Round(random.NextDouble()), KresVarMi = (int)Math.Round(random.NextDouble()), CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            ...
            new Adliye { Adi = "Çanakkale Adliyesi", Adres = "", ResimUrl = "https://rayp.adalet.gov.tr/Resimler/9/211-03-202014-06.jpg", YapimYili = random.Next(1985, 2024), PersonelSayisi = random.Next(500, 7501), LojmanVarMi = (int)Math.Round(random.NextDouble()), KresVarMi = (int)Math.Round(random.NextDouble()), CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            ...
            new Adliye { Adi = "Denizli Adliyesi", Adres = "", ResimUrl = "https://rayp.adalet.gov.tr/Resimler/515/img-0394jpg29-07-202012-0018-10-202105-07.jpg", YapimYili = random.Next(1985, 2024), PersonelSayisi = random.Next(500, 7501), LojmanVarMi = (int)Math.Round(random.NextDouble()), KresVarMi = (int)Math.Round(random.NextDouble()), CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
